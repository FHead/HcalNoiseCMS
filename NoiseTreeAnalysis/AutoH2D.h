...
// "AutoH2D" helper function to create instances of this wrapper.
//
// I. Volobouev
// March 2013
//
...
// of this class directly, call the "AutoH2D" function instead.
//
template<class Functor1, class Functor2, class Functor3>
class AutoH2DHelper : public ManagedHisto
{
public:
    inline AutoH2DHelper(const char* name, const char* title,
...
//
// The AutoH2D function arguments are as follows:
//
...
//               method "operator()()" whose result must be convertible
//               to double.
//
...
//
template<class Functor1, class Functor2, class Functor3>
inline AutoH2DHelper<Functor1,Functor2,Functor3>* AutoH2D(
...
{
    return new AutoH2DHelper<Functor1,Functor2,Functor3>(
