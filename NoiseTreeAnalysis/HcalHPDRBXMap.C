...
HcalSubdetector HcalHPDRBXMap::subdetHPD(int index)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::subdetHPD: HPD index "
         << index << " is invalid";
...
HcalSubdetector HcalHPDRBXMap::subdetRBX(int index)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::subdetRBX: RBX index "
         << index << " is invalid";
  }
...
int HcalHPDRBXMap::zsideHPD(int index)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::zsideHPD: HPD index "
         << index << " is invalid";
      throw std::invalid_argument(os.str());
  }
...
int HcalHPDRBXMap::zsideRBX(int index)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::zsideRBX: RBX index "
         << index << " is invalid";
      throw std::invalid_argument(os.str());
  }
...
int HcalHPDRBXMap::iphiloHPD(int index)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::iphiloHPD: HPD index "
         << index << " is invalid";
      throw std::invalid_argument(os.str());
  }
...
int HcalHPDRBXMap::iphiloRBX(int index)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::iphiloRBX: RBX index "
         << index << " is invalid";
      throw std::invalid_argument(os.str());
  }
...
int HcalHPDRBXMap::iphihiHPD(int index)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::iphihiHPD: HPD index "
         << index << " is invalid";
      throw std::invalid_argument(os.str());
  }
...
int HcalHPDRBXMap::iphihiRBX(int index)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::iphihiRBX: RBX index "
         << index << " is invalid";
      throw std::invalid_argument(os.str());
  }
...
void HcalHPDRBXMap::indicesHPDfromRBX(int rbxindex, std::array<int, NUM_HPDS_PER_RBX>& hpdindices)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::subdetHPD: RBX index "
         << rbxindex << " is invalid";
      throw std::invalid_argument(os.str());
  }
...
int HcalHPDRBXMap::indexRBXfromHPD(int hpdindex)
{
  ...
  {
      ostringstream os;
      os << "In HcalHPDRBXMap::indexRBXfromHPD: HPD index "
         << hpdindex << " is invalid";
      throw std::invalid_argument(os.str());
  }
...
int HcalHPDRBXMap::indexHPD(const HcalDetId& id)
{
  ...
  if(!isValid(id)) {
      ostringstream os;
      os << "In HcalHPDRBXMap::indexHPD: HcalDetId "
         << id << " is invalid";
      throw std::invalid_argument(os.str());
  }
